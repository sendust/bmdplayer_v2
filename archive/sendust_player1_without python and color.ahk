...
;python_info := new class_python_info("127.0.0.1", 8901)				; added 2020/12/27


title := "sendust multi channel player - " . get_casparchannel(A_ScriptName) . " -  2020/12/21"
...
debug_mode := 1
simple_tc := 0					; simple_tc ; simplified TC display (for SBS ts-6)			; 2020/11/30
...
{
	global hstatus, tcptext, watchdog, tts
