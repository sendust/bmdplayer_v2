...
title =  sMXF Player v2.2 by sendust 20190708
...
Gui, add, button, xp+90 w80 h30 hwndhpreviewsdi gpreviewsdi , TEST
...
if StrLen(xmlfile) > 20
{
    ...
    */	
	...
	if (caspar.listplay and (caspar.timerem < 4) and (caspar.timerem > 2) and !caspar.loadbg_try and (caspar.pbposition <= LV_GetCount()))			; current play is listplay and remaining time is between 4 and 3
	{
...
caspar_inout_file["path"] := media.fullpath
