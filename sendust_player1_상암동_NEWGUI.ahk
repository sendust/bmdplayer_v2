...
title := "sendust multi channel player - " . get_casparchannel(A_ScriptName) . " -  2021/4/19"
flag_engine_version := "2.3"				; Select 2.1 or 2.3
debug_mode := 0
...
osc_reader_title := flag_engine_version = "2.3" ?  osc_reader_title : "Caspar v2.1 OSC Monitor by sendust"
simple_tc := 1					; simple_tc ; simplified TC display (for SBS ts-6)			; 2020/11/30
script_python_info := flag_engine_version = "2.3" ?  "osc_v23.py" : "osc_v21.py"
;osc_reader := flag_engine_version = "2.3" ? osc_reader : A_ScriptDir . "\dummy." . ahk_exe
...
Gui, add, Progress, xm+360 ym w5 h850, 100			; vertical bar -----------------------------------------------------
...
Gui, add, ListView, xm+370 ym+30 w1500 h710 hwndhlistview vVLV glvclick NoSortHdr NoSort ReadOnly -LV0x10, STATUS|TITLE|IN|OUT|DURATION|CLIP LIST|AUDIO
...
Gui, add, Button, xp+120 yp-80 w100 h40 gcommercial Disabled, 대체광고시작
...
updatelog("Engine version is " . flag_engine_version)
...
if (flag_engine_version = "2.1")		; version higher than 2.3 require field rate (frame x 2)
...
if (flag_engine_version = "2.3")						; changed 2021/3/16
{
