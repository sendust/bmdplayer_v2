...
def drawframe():
    ...
    font = pygame.font.Font("DSEG7Classic-Italic.ttf", 20)
    text = font.render(str(info_display.time[0]), True, (255, 255, 255))
    window.screen.blit(text, info_display.position["time0"])
    text = font.render(str(info_display.time[1]), True, (255, 255, 255))
    window.screen.blit(text, info_display.position["time1"])        
    
    text = font.render(str(info_display.clip[0]), True, (255, 255, 255))
    window.screen.blit(text, info_display.position["clip0"])    
    text = font.render(str(info_display.clip[1]), True, (255, 255, 255))
    window.screen.blit(text, info_display.position["clip1"])    
    text = font.render(str(info_display.clip[2]), True, (255, 255, 255))
    window.screen.blit(text, info_display.position["clip2"])    
    text = font.render(str(info_display.clip[3]), True, (255, 255, 255))
    window.screen.blit(text, info_display.position["clip3"])    

    text = font.render(str(info_display.markers[0]), True, (255, 255, 255))
    window.screen.blit(text, info_display.position["markers0"])    
    text = font.render(str(info_display.markers[1]), True, (255, 255, 255))
    window.screen.blit(text, info_display.position["markers1"])    

    #text = font.render(str(info_display.time_profiler[0]), True, (255, 255, 255))
    #window.screen.blit(text, info_display.position["time_profiler0"])    
    #text = font.render(str(info_display.time_profiler[1]), True, (255, 255, 255))
    #window.screen.blit(text, info_display.position["time_profiler1"])    

    font = pygame.font.SysFont("gulimgulimchedotumdotumche", 20)
    text = font.render(str(info_display.path[0]), True, (255, 255, 255))
    window.screen.blit(text, info_display.position["path"])    
    
    text = font.render(str(info_display.paused[0]), True, (255, 255, 255))
    window.screen.blit(text, info_display.position["paused"])   

    text = font.render(str(info_display.loop[0]), True, (255, 255, 255))
    window.screen.blit(text, info_display.position["loop"])   

    text = font.render(str(info_display.type[0]), True, (255, 255, 255))
    window.screen.blit(text, info_display.position["type"])   
